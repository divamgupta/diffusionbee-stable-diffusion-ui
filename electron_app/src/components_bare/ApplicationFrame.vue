  ...
  <div class="main_frame">
      ...
      <div class="app_title" v-bind:class="{ fullscreen: is_fullscreen || detect_windows_os() }">
        ...
        <div style="float: right; margin-right: 10px; margin-top: -8.5px" class="">
          <b-dropdown right variant="link" size="sm" toggle-class="text-decoration-none" no-caret>
            ...
            <b-dropdown-item @click="$emit('menu_item_click_help', {})" href="#"
              >Help</b-dropdown-item
            >
            <b-dropdown-item @click="$emit('menu_item_click_about', {})" href="#"
              >About</b-dropdown-item
            >
            <b-dropdown-item @click="$emit('menu_item_click_close', {})" href="#"
    ...
    <div class="tabs_bar">
      ...
      <div
        ...
        class="tab l_button"
        v-bind:class="{ button_colored: selected_tab === 'logs' }"
      >
        Logs
      </div>
    </div>
