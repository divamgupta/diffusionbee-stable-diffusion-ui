        ...
        <b-dropdown id="dropdown-form" variant="link" ref="dropdown" toggle-class="text-decoration-none" no-caret>
            ...
            <b-dropdown-form style="min-width: 350px;max-height: calc(100vh - 300px); overflow-y: scroll;">
                ...
                <div style="display: flex;flex-wrap: wrap;justify-content: center;gap: 15px;">
                    ...
                    <span v-if="elements_extra && elements_extra.includes('controlnet')">
                        <div class="options_title">
                            <div class="options_title_box" style="width: 165px;">
                                <span>ControlNet Model</span>
                                <span class="options_desc">What aspect of the input image it should use to generate the image.</span>
                            </div>
                            <div class="options_input" style="width: 115px;">
                                ...
                                <b-form-select v-model="options_model_values.selected_control"
                                    :options="['Body Pose' , 'Depth' , 'Scribble' ]"
                    ...
                    <span v-if="elements_extra && elements_extra.includes('controlnet')">
                        <div class="options_title">
                            <div class="options_title_box" style="width: 165px;">
                                <span>Automatically generate control</span>
                                <span class="options_desc">If it should automatically generate the control. If you select No, you have to input raw control image.</span>
                            </div>
                            <div class="options_input" style="width: 115px;">
                                <svg width="18" height="19" viewBox="0 0 18 19" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                ...
                                <b-form-select v-model="options_model_values.do_controlnet_preprocess"
                                    :options="['Yes' , 'No' ]"
                                    required></b-form-select>
                            </div>
                        </div>
