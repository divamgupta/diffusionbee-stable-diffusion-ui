...
export default {
  ...
  props: {
    ...
    is_disabled: Boolean,
    constraints: Array, // list of all validation checks applied on the input element
  },
  components: {},
  mounted() {},
  data() {
    return {
      ...
      is_form_entry_fresh: this.value == '', // used to determine if the element is empty and value has not been changed yet
    }
  },
  methods: {
    on_input_changed() {
