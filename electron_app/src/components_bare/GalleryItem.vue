  ...
  >
    ...
    >
      ...
      <div v-if="type == 'img_text'" style="height: 100%">
        <img
          class="gallery_img"
          style="height: 70%; max-height: 70%; width: 100%"
          :src="url"
        />
      ...
      <div
        v-if="top_right_icon || top_right_button_text"
        class="gall_top_right_btn_container"
      >
        <div
          v-on:click.stop
...
export default {
  ...
  props: {
    ...
    top_right_icon: String, // if you want to show a FA icon on top right of the item , eg delete
    top_right_button_text: String, // if you want to show text button on top right
  },
