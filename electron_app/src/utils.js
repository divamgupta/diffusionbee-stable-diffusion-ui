...
function resolve_asset_illustration(name) {
  ...
  if (pre_assets_list_svg.includes(name)) return require('@/assets/' + name + '.svg')
  else if (pre_assets_list_png.includes(name)) return require('@/assets/' + name + '.png')
  else if (name.startsWith('https://') || name.startsWith('http://')) return name
